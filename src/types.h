...
#define CAMERA_X        -200.1
#define CAMERA_Y        200.0
#define CAMERA_Z        300.0
...
#define SPRING_EXPANSION_MAX	0.01

/* Guter Wert bei Lamda=0.8 und g=-0.2 */

#define K_STRUCTURE		1.1
#define K_SHEER			1.1
#define K_BEND			0.5

#define PARTICLE_FIXED_SIDE	1

/* Mit 1/5 der Kräfte der Nachbarpartikel */
/*
#define K_STRUCTURE		0.5
#define K_SHEER			0.1
#define K_BEND			0.9
*/

/*
#define K_STRUCTURE		2.0
#define K_SHEER			1.5
#define K_BEND			1.0
*/
#define F_MIN			0.005
...
#define WIND_FORCE	0.0005
#define WIND_DIR	{-1.0,-1.0,-1.0}
#define WIND_EDGE_FACTOR	10.0
